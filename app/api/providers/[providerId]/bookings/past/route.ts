...
import { getPastBookings } from "@/db/queries/bookings-queries";
import { db } from "@/db/db";
import { providersTable } from "@/db/schema/providers-schema";
import { eq } from "drizzle-orm";

// GET /api/providers/[providerId]/bookings/past - Get past bookings for a provider
export async function GET(
  ...
  try {
    ...
    const { bookings, total } = await getPastBookings(
      params.providerId,
      limit,
      offset
    );

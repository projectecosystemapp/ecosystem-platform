...
// import { useFeaturedProviders } from "@/hooks/api/useProviders";
...
export default function ProvidersPage() {
  ...
  // Simplified for cleanup - use basic state instead of complex hook
  const [providers, setProviders] = useState<any[]>([]);
  const [isSearching, setIsSearching] = useState(false);
  const [searchError, setSearchError] = useState<any>(null);

  // Simplified featured providers for cleanup
  ...
  const handleSearch = async () => {
    ...
    // Simplified search - just set loading state
    setIsSearching(true);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            {/* Load More - simplified for cleanup */}
            {false && (
